...
function renderBillsContent() {
    ...
    document.getElementById('upcoming-total').textContent = `$${upcomingTotal.toFixed(2)}`;
    document.getElementById('due-soon-total').textContent = `$${dueSoonTotal.toFixed(2)}`;
...
export function renderBills() {
  ...
  `;
    (_a = document.getElementById('add-bill-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
        document.getElementById('bill-modal').style.display = 'flex';
    });
    (_b = document.getElementById('cancel-bill')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
        document.getElementById('bill-modal').style.display = 'none';
    });
    (_c = document.getElementById('save-bill')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
        const name = document.getElementById('bl-name').value.trim();
        const amount = parseFloat(document.getElementById('bl-amount').value);
        const dueDay = parseInt(document.getElementById('bl-day').value);
