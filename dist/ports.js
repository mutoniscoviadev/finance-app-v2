...
export function renderPots() {
  ...
  `;
    ...
    (_a = document.getElementById('add-pot-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
        document.getElementById('pot-modal').style.display = 'flex';
    });
    (_b = document.getElementById('cancel-pot')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
        document.getElementById('pot-modal').style.display = 'none';
    });
    (_c = document.getElementById('save-pot')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
        var _a;
        const name = document.getElementById('p-name').value.trim();
        const target = parseFloat(document.getElementById('p-target').value);
        const theme = (_a = document.querySelector('input[name="p-theme"]:checked')) === null || _a === void 0 ? void 0 : _a.value;
