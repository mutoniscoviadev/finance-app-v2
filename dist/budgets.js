  ...
  `;
    ...
    document.querySelectorAll('input[name="b-theme"]').forEach(radio => {
        radio.addEventListener('change', () => {
            ...
            radio.nextElementSibling.style.borderColor = '#333';
        });
    });
    // Open modal
    (_a = document.getElementById('add-budget-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
        document.getElementById('budget-modal').style.display = 'flex';
    });
    // Close modal
    (_b = document.getElementById('cancel-budget')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
        document.getElementById('budget-modal').style.display = 'none';
    });
    // Save budget
    (_c = document.getElementById('save-budget')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
        var _a;
        const category = document.getElementById('b-category').value;
        const maximum = parseFloat(document.getElementById('b-max').value);
        const theme = (_a = document.querySelector('input[name="b-theme"]:checked')) === null || _a === void 0 ? void 0 : _a.value;
