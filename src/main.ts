...
function showApp(page: string): void {
  ...
  else if (page === 'add-transaction') renderAddTransaction();
  else if (page === 'budgets')         renderBudgets();
  else if (page === 'pots')            renderPots();
...
window.addEventListener('navigate',    (e: Event) => navigate((e as CustomEvent).detail));
